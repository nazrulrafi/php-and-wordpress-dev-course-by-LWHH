# WordPress & PHP Development Courses (LWHH)
...
- Theme Conversion (HTML → WordPress)
- Hooks, Filters, Shortcodes
- Custom Post Types & Meta Fields

## 🎯 Purpose of This Repository
- Document my WordPress & PHP learning journey
- Practice real-world WordPress development concepts
- Use as a reference for professional projects and interviews
